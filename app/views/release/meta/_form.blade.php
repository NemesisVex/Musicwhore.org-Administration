...
<div class="form-group">
	{{ Form::label( 'discogs_id', 'Discogs ID', array( 'class' => 'col-md-3', 'id' => 'discogs-id-label', 'title' => 'Map to Release', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom' ) ) }}
	<div class="col-md-9">
		{{ Form::text( 'discogs_id', $release->meta->discogs_id, array( 'class' => 'form-control' ) ) }}
	</div>
</div>
